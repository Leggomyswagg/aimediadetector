        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-cyan-500/10 border border-cyan-500/20">
              ...
              <span className="text-cyan-400 text-sm font-medium">Real-time AI Detection Active</span>
            </div>
            ...
            <p className="text-lg sm:text-xl text-gray-400 max-w-xl leading-relaxed">
              Protect yourself from deepfakes, AI-generated images, synthetic voices, and manipulated videos. 
              Our advanced detection runs silently in the background while you browse.
            </p>
